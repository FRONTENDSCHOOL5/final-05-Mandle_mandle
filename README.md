...
- 🌳우경석<br/>
  프로젝트를 시작하기 전 과연 내가 할 수 있을까 하는 생각을 가지고 시작하였으나 프로젝트를 진행하면서 할 수 있다는 생각을 가지게 되었습니다. 시작하기 전에는 어색했던 React 문법이 점차 익숙해지고 코드를 읽을 수 있는

  실력의 한계를 느꼈지만 질문과 학습을 통해 한계를 극복할 수 있었고 협업할 수 있는 경험까지 많은 걸 배울 수 있는 프로젝트 기간이였다.

- ☘️ 윤서준<br/>

<h3 align="right"><a href="#top">(🔼 Top)</a></p>
