...
<details>
  <summary>🍀윤서준</summary>
  이번 팀 프로젝트를 통해 협업 과정으로도 기술적으로도 짧은 시간이지만 더 큰 성장을 이루는 특별한 경험이었습니다 특히 API 통신을 통해 실제 서버와의 요청 응답 원리를 이해하고, 다른 사람들의 코드를 읽고 이해하는 능력을 쌓으면서 한 단계 더 성장할 수 있었습니다. 마지막까지 항상 의견 내주시고 열정적으로 임해주신 팀원분들 덕에 프로젝트를 성공적으로 마무리할 수 있었습니다. 다들 수고하셨어요!!
</details>
